    ...
    return(
        <>
            ...
            <div class="nav nav-tabs" id="product-tab" role="tablist">
                <button class="nav-link custom-tab-font active" id="nav-description-tab" data-bs-toggle="tab" data-bs-target="#nav-description" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Description</button>
                <button class="nav-link custom-tab-font" id="nav-rating-tab" data-bs-toggle="tab" data-bs-target="#nav-rating" type="button" role="tab" aria-controls="nav-rating" aria-selected="false">Reviews ({data.reviews?.length || 0})</button>
            </div>
            </nav>
