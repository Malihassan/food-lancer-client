...
function ProductEditPanel(props) {
    ...
    const formHandler = async (e) => {
        ...
        switch (e.target.name) {
            case "nameField":
                ...
                setEditFormErr({
                    ...editFormErr, nameFieldErr: !e.target.value.length
            ...
            case "priceField":
                ...
                setEditFormErr({
                    ...editFormErr, priceFieldErr: !e.target.value.length
                        ? "This field is required..."
            ...
            case "descriptionField":
                ...
                setEditFormErr({
                    ...editFormErr, descriptionFieldErr: !e.target.value.length
                        ? "This field is required..."
                        : null
                });
    ...
    const imageHandler = (files) => {
        ...
        setEditFormErr({
            ...editFormErr, imagesFieldErr: !files.length
                ? "This field is required..."
                : files.length > 5 ?
    ...
    const editDetails = async (e) => {
        ...
        Array.from(editForm.imagesField).forEach(file => formData.append("image", file));
        ...
        await (async () => {
            console.log("RESULT");
            const res = await axiosInstance.patch(`seller/product/${data._id}`, 
                formData,
        ...
        <>
            <div className="row flex-xl-row flex-column justify-content-between text-dark p-2">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="editForm" onSubmit={editDetails} >
                                    <div className="my-4">
                                        <label htmlFor="exampleInputEmail1" className="form-label text-start">Product Name</label>
                                        <input type="text" name="nameField" onChange={(e) => formHandler(e)} value={editForm.nameField} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required />
                                    ...
                                    <div className="my-4">
                                        <label htmlFor="exampleInputPassword1" className="form-label text-start">Price</label>
                                        <input type="text" name="priceField" onChange={(e) => formHandler(e)} value={editForm.priceField} className="form-control" id="exampleInputPassword1" required />
                                        <div className="text-danger">
                                            <small>
                                    ...
                                    <div className="my-4">
                                        <label htmlFor="exampleInputPassword1" className="form-label text-start">Description</label>
                                        <input type="text" name="descriptionField" onChange={(e) => formHandler(e)} value={editForm.descriptionField} className="form-control" id="exampleInputPassword1" required />
                                        <div className="text-danger">
                                            <small>
                                    ...
                                    <div className="my-4">
                                        <label htmlFor="exampleInputPassword1" className="form-label text-start">Images</label>
                                        <input type="file" name="imagesField" onChange={(e) => imageHandler(e.target.files)} className="form-control" id="exampleInputPassword1" required multiple />
                                        <div className="text-danger">
                                            <small>
                                                {editFormErr.imagesFieldErr}
                                            </small>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" form="editForm" disabled={editFormErr.nameFieldErr || editFormErr.priceFieldErr || editFormErr.imagesFieldErr || editFormErr.descriptionFieldErr} class="btn btn-dark">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-xl-6 col-12 mt-4 mt-xl-0">
                    ...
                    <div className="my-5">
                        <h5><span class={`badge ${data.status === "pending"? "bg-warning": data.status === "active"? "bg-success" : "bg-danger"}`}>{data.status}</span></h5>
                    </div>
