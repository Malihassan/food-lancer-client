...
function ProductTabs(props) {
  ...
  return (
    <>
      <div className="productTabsContainer mt-4">
        <nav>
          <div className="nav nav-tabs" id="product-tab" role="tablist">
            <button
              className="nav-link custom-tab-font active fs-5 fw-bold"
            ...
            <button
              className="nav-link custom-tab-font fs-5 fw-bold"
              id="nav-rating-tab"
              data-bs-toggle="tab"
        ...
        <div className="tab-content" id="nav-tabContent">
          <div
            className="tab-pane text-dark fade show active p-2"
            id="nav-description"
            role="tabpanel"
          ...
          <ul
            className="tab-pane  fade p-2 list-group list-group-flush"
            id="nav-rating"
            role="tabpanel"
