  ...
  return (
    <div className={`${classes.cardColor} shadow-sm`}>
          ...
          >
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src={jpg1} class="d-block w-100" style={{height:"365px"}}  alt="..." />
              </div>
              <div class="carousel-item">
                <img src={jpg} class="d-block w-100" style={{height:"365px"}} alt="..." />
              </div>
              <div class="carousel-item">
                <img src={jpg2} class="d-block w-100" style={{height:"365px"}} alt="..." />
              </div>
            </div>
          </div>
          {/* <img
      ...
      <div className="card-body">
        ...
        >
          A topping of spicy barbeque sauce, diced chicken, cilantro, peppers,
          and onion all covered with cheese, and baked to bubbly goodness!
        </p>
