                            ...
                            >
                              ...
                              <div className="align-self-center col-3">
                                ...
                                <div className="fw-bold text-info">
                                  Total:{" "}
                                  {(product.price * product.serves).toFixed(2)}
                                  &#163;
                                </div>
                              </div>
                            </li>
                ...
                <ul className="list-group list-group-flush p-1">
                  ...
                  <li className="list-group-item fw-light my-2">
                    <div className="d-flex justify-content-between">
                      <div>Price</div>
                      <div>
                        {orderCards.sellerOrderPrice[seller].toFixed(2)}
                        &#163;
                      </div>
                    </div>
                    <div className="d-flex justify-content-between">
                  ...
                  <li className="list-group-item d-flex flex-column">
                    ...
                    <button
                      disabled={address[idx] && !addressErr[idx] ? false : true}
                      onClick={() =>
                        postOrder(
