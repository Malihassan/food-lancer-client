      ...
      <>
        ...
        <nav >
          ...
          <div className="tab-content" id="nav-tabContent">
              <div className="tab-pane fade show active p-2" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">{data.description}</div>
              <ul className="tab-pane fade p-2 list-group list-group-flush" id="nav-rating" role="tabpanel" aria-labelledby="nav-rating-tab">
